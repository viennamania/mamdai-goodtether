  ...
  */
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      //console.log('top1 user====>', data?.data);
      ...
      if (data?.data) {
        ...
        setSurveyResult(data.data?.surveyResult);
  ...
  /////console.log('serveyResult====>', surveyResult);
  ...
  return (
    ...
    >
      <div
        className=" xl:w-[1000px] flex flex-row items-center justify-between "
