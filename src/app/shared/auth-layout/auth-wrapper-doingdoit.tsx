...
export default function AuthWrapperDoingDoit({
  children,
  title,
  ...
  return (
    <>
      ...
      <div className="relative flex min-h-screen w-full flex-col justify-center bg-[#f2f5f9] p-4 md:p-12 lg:p-28">

      <div className=' mb-10 flex justify-center items-center'>
        <Image
          className=" object-contain"
          src="/logo-goodtether.png"
          alt="Logo"
          width={400}
          height={200}
        />
        ...
        */}
        <div
          className={cn(
            'mx-auto w-full max-w-md rounded-xl bg-white px-4 py-9 dark:bg-gray-50 sm:px-6 md:max-w-xl md:px-10 md:py-12 lg:max-w-[500px] lg:px-16 xl:rounded-2xl 3xl:rounded-3xl',
            className
          )}
        >
