...
export default function Create() {
  ...
  */
  ...
  const onSubmit: SubmitHandler<ProfileFormTypes> = async (data) => {
    ...
    // call api
    const res = await fetch(`/api/doingdoit/user/setOneManager`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
      body: JSON.stringify({
        email: data.loginId + '@cryptopay.beauty',
                    ...
                    <Input
                      ...
                      onChange={
                        ...
                        async (e) => {
                          ...
                          const res = await fetch(`/api/doingdoit/user/checkDuplicateEmail?_email=${e.target.value + '@cryptopay.beauty'}`);
