...
export default function BoardPage({ params }: any) {
  ...
  */
  ...
  const editComment = async (commentId: string, commentContent: string) => {
    ...
    const res = await fetch(`/api/doingdoit/board/editComment`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  const editReply = async (replyId: string, replyContent: string) => {
    ...
    const res = await fetch(`/api/doingdoit/board/editReply`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
              ...
              <Button
                ...
                onClick={
                  ...
                  if (deleteMethod == 'comment') {
                    ...
                    const res = await fetch(`/api/doingdoit/board/deleteReply?id=${deleteReplyId}`);
                    const json = await res?.json();
