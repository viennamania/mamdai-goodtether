    ...
    const fetchSurveyResult = async () => {
      ...
      if (id) {
        ...
        if (data) {
          ...
          const { character, nutrition } = data?.data?.surveyResult;
  ...
  const onShare = async () => {
    ...
    await window.Kakao.Share.sendDefault({
      ...
      link: {
        ...
        mobileWebUrl: "https://orangex.center/usermain/survey/result/" + id,
        webUrl: "https://orangex.center/usermain/survey/result/" + id,
      },
    });
