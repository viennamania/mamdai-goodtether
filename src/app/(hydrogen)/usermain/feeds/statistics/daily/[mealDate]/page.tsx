  ...
  */
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const res = await fetch(`/api/doingdoit/feed/getStatisticsDayByEmail?_email=${session?.user?.email}&_mealDate=${mealDate}`);
              ...
              <div className="self-stretch flex flex-col items-center justify-start gap-[20px] text-left text-xl">
                ...
                <div className="self-stretch flex flex-col items-center justify-start gap-[8px] text-sm">
                  ...
                  <div className="self-stretch flex flex-row items-end justify-start">
                    ...
                    <div className=" flex flex-col items-start justify-center relative gap-[4px] text-center text-3xs text-orange">
                      ...
                      <div className="self-stretch rounded-81xl bg-background flex flex-col items-start justify-center z-[1] text-white">
                        <div className="rounded-81xl bg-orange h-6 flex flex-row items-center justify-center py-0 px-3 box-border w-[30%] ">
                  ...
                  <div className="self-stretch flex flex-row items-end justify-start">
                    ...
                    <div className="flex flex-col items-start justify-center relative gap-[4px] text-center text-3xs text-red">
                      ...
                      <div className="rounded-81xl bg-background flex flex-col items-start justify-center z-[1] text-white">

                        <div className="rounded-81xl bg-red h-6 flex flex-row items-center justify-center py-0 px-3 box-border    w-[50%] ">
                          <div className="relative font-extrabold">2400</div>
                        </div>
                        
                      </div>

                      <div className="absolute my-0 mx-[!important] top-[15px] bg-orange-light w-0.5 h-6 z-[2]" />
