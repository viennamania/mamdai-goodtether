...
export const getStaticProps: GetStaticProps = async () => {
  ...
  const image = 'https://orangex.center/logo.webp';
  ...
  useEffect(() => {
    ...
    const fetchSurveyResult = async () => {
      ...
      if (userData?.id) {
        ...
        ///const res = await fetch(`/api/doingdoit/survey/resultById?_id=${id}`);

        const res = await fetch(`/api/doingdoit/survey/resultByUserId?_userId=${userData?.id}`);
  ...
  const onShare = async () => {
    ...
    await window.Kakao.Share.sendDefault({
      ...
      link: {
        ...
        mobileWebUrl: "https://orangex.center/usermain/survey/result/" + surveyResultId,
        webUrl: "https://orangex.center/usermain/survey/result/" + surveyResultId,
      },
    });
                ...
                */}
                ...
                <button
                  onClick={() => {
                    ...
                    const { Kakao, location } = window;
                    Kakao?.Link?.sendScrap({
                      requestUrl: 'https://orangex.center/usermain/survey/result/' + id,
                    });
                    */
